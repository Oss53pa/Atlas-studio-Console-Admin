  ...
  return (
    <div style={{ padding: '24px 32px', textAlign: 'center', borderTop: '0.5px solid #EEE' }}>
      ...
      <div style={{ marginTop: 8 }}>
        <span style={{ fontSize: 11, color: 'var(--c-accent)', cursor: 'pointer' }}>{unsubscribeText}</span>
        <span style={{ fontSize: 11, color }}> · </span>
        <span style={{ fontSize: 11, color: 'var(--c-accent)', cursor: 'pointer' }}>Voir en ligne</span>
      </div>
    </div>
  )
}
