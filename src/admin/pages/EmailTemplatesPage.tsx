...
const HEADER = `<tr><td style="background:linear-gradient(135deg,var(--c-surface) 0%,var(--c-surface) 50%,var(--c-surface) 100%);padding:36px 40px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#ffffff;letter-spacing:2px;">ATLAS <span style="color:#C0635C;">STUDIO</span></div><div style="font-size:12px;color:#B9B7B1;margin-top:4px;letter-spacing:1px;">atlasstudio.org</div></td></tr>`;

const FOOTER = (extra: string) => `<tr><td style="background:#F5F5F4;border-top:1px solid #E9E8E6;padding:20px 40px;text-align:center;"><p style="margin:0;font-size:12px;color:#B9B7B1;">&copy; Atlas Studio | <a href="https://atlasstudio.org" style="color:#B9B7B1;text-decoration:none;">atlasstudio.org</a> | <a href="mailto:support@atlasstudio.org" style="color:#B9B7B1;text-decoration:none;">support@atlasstudio.org</a></p><p style="margin:6px 0 0;font-size:11px;color:#D6D5D1;">${extra}</p></td></tr>`;
