...
const HEADER = `<tr><td style="background:linear-gradient(135deg,#17171a 0%,#212126 50%,#212126 100%);padding:36px 40px;text-align:center;"><div style="font-size:28px;font-weight:800;color:#ffffff;letter-spacing:2px;">ATLAS <span style="color:#C0635C;">STUDIO</span></div><div style="font-size:12px;color:#B9B7B1;margin-top:4px;letter-spacing:1px;">atlasstudio.org</div></td></tr>`;
