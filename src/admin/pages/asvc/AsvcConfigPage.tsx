...
export default function AsvcConfigPage() {
  return (
    <div className="max-w-3xl">
      ...
      <div className="rounded-xl border border-p-border bg-p-surface-alt/50 p-6">
        <div className="flex items-center gap-2 mb-3">
          <Construction size={16} className="text-admin-accent" />
          <h2 className="text-neutral-light text-sm font-semibold">À venir</h2>
        </div>
        <p className="text-p-muted text-[13px] leading-relaxed">
          Cet écran exposera les contrôles fins par agent :
        </p>
        <ul className="mt-3 space-y-1.5 text-[12.5px] text-p-muted list-disc list-inside marker:text-admin-accent">
        ...
        <div className="mt-5 pt-4 border-t border-p-border flex items-center gap-2 text-neutral-600 text-[11px]">
          <Settings size={11} />
