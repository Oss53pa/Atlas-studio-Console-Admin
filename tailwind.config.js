  ...
  theme: {
    extend: {
      colors: {
        ...
        // Forme rgb(var(--x-rgb) / <alpha-value>) → les opacités Tailwind marchent.
        p: {
          bg: 'rgb(var(--c-bg-rgb) / <alpha-value>)',
          surface: 'rgb(var(--c-surface-rgb) / <alpha-value>)',
          'surface-alt': 'rgb(var(--c-surface-alt-rgb) / <alpha-value>)',
        ...
        ink: {
          ...
          50: 'rgb(var(--c-bg-rgb) / <alpha-value>)',
          100: 'rgb(var(--c-surface-rgb) / <alpha-value>)',
          200: 'rgb(var(--c-surface-alt-rgb) / <alpha-value>)',
          300: 'rgb(var(--c-surface-alt-rgb) / <alpha-value>)',
          400: 'rgb(var(--c-border-rgb) / <alpha-value>)',
          500: 'rgb(var(--c-border-rgb) / <alpha-value>)',
        },
        ...
        gold: {
          ...
          400: 'var(--c-accent)',
          500: 'var(--c-accent)',
          600: 'var(--c-accent-dark)',
          700: 'var(--c-accent-dark)',
          800: 'var(--c-accent-dark)',
          light: 'var(--c-accent)',
          dark: 'var(--c-accent-dark)',
          deep: 'var(--c-accent-dark)',
        },
        // SECONDARY ACCENT — Cream / ivoire — used for "Atlas Studio" brand wordmark.
        champagne: {
          DEFAULT: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 50: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 100: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 200: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 300: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 400: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 500: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', 600: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)', light: 'rgb(var(--c-accent-rgb) / <alpha-value>)', dark: 'rgb(var(--c-accent-dark-rgb) / <alpha-value>)' },
        ...
        dark: {
          bg: 'rgb(var(--c-bg-rgb) / <alpha-value>)',
          bg2: 'rgb(var(--c-surface-rgb) / <alpha-value>)',
          bg3: 'rgb(var(--c-surface-alt-rgb) / <alpha-value>)',
          bg4: 'rgb(var(--c-surface-alt-rgb) / <alpha-value>)',
          border: 'rgb(var(--c-border-rgb) / <alpha-value>)',
          border2: 'rgb(var(--c-border-rgb) / <alpha-value>)',
          border3: 'rgb(var(--c-border-rgb) / <alpha-value>)',
        },
        admin: {
          bg: 'rgb(var(--c-bg-rgb) / <alpha-value>)',
          surface: 'rgb(var(--c-surface-rgb) / <alpha-value>)',
          ...
          text: 'rgb(var(--c-text-rgb) / <alpha-value>)',
          muted: 'rgb(var(--c-muted-rgb) / <alpha-value>)',
          success: 'rgb(var(--c-ok-rgb) / <alpha-value>)',
          error: 'rgb(var(--c-err-rgb) / <alpha-value>)',
          warning: 'rgb(var(--c-warn-rgb) / <alpha-value>)',
          info: '#7E94B8',
        },
        neutral: {
